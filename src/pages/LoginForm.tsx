...
const LoginForm: React.FC = () => {
    ...
    return (
        <div className="flex items-center justify-center min-h-screen bg-gradient-to-r from-gray-200 via-gray-300 to-gray-400 px-4">
            <div className="bg-gray-800 p-6 sm:p-8 rounded-lg shadow-lg w-full max-w-xs sm:max-w-md lg:max-w-lg">
                        ...
                        <Form>
                            ...
                            <div className="mb-4">
                                ...
                                <Field
                                    ...
                                    className="w-full px-4 py-2 border border-gray-300 rounded-md text-white focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:border-transparent"
                                />
                                <ErrorMessage
                                    name="email"
                                    component="div"
